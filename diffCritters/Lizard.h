...
/**
 * @class Lizard - Critter that moves like an inch worm across the screen.
 *
 ...
 */
class Lizard : public Critter {
public:
    /**
     * Lizard is created EASTbound and in BUNCHED state.
     *
     * @param row  initial placement of head
     * @param col  initial placement of head
     */
    Lizard(int row, int col);
...
private:
     ...
     */
    friend std::ostream& operator<<(std::ostream& out, Lizard::State state);
};
